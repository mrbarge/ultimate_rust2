...
pub enum DolphinError {
    /// The dolphin is hungry
    #[error("they're too hungry")]
    Hungry,
    /// The dolphin is too young
    #[error("they're too young")]
    TooYoung,
    /// The dolphin's name is too long and annoying to say
    #[error("their name is too long")]
    LongName,
}
